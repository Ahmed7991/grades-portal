...
def progress_html(label, value, max_val, color):
    ...
    <div style="margin-bottom: 12px;">
        <div class="bar-label">
            ...
            <span style="color:#1e293b;">{val:g} / {max_val}</span>
        </div>
        <div class="bar-bg">
...
def main():
    ...
    if not st.session_state.logged_in:
        ...
        with c2:
            st.markdown("""
            <div class="pro-card" style="text-align: center; border-top: 4px solid #1e293b;">
                <div style="font-size: 3rem; margin-bottom: 10px;">🔐</div>
                <h2 style="margin-bottom: 5px;">بوابة الطالب</h2>
                <p style="color:#64748b; font-size: 0.9rem;">أدخل رمز الدخول لعرض النتائج</p>
            </div>
            """, unsafe_allow_html=True)
    ...
    # 2. DASHBOARD SCREEN
        ...
        <div class="pro-card" style="display:flex; justify-content:space-between; align-items:center;">
            <div style="text-align:right;">
                <h2 style="font-size:1.4rem; margin:0;">{student_name}</h2>
                <p style="margin:0; font-size:0.9rem;">لوحة النتائج الفصلية</p>
            </div>
        ...
        if grades_df is None:
            ...
            if record.empty:
                ...
                try:
                    ...
                    rank = df_sort[df_sort['اسم الطالب'].str.strip() == student_name.strip()].index[0] + 1
                except:
                    rank = "-"
